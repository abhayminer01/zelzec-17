...
export default function NavBar() {
  ...
  return (
    <>
      <div className="w-full h-16 bg-white md:h-20 flex justify-center border-b border-border">
        <div className="w-full max-w-[1600px] h-full flex items-center justify-between px-4 md:px-8 lg:px-12 gap-10">
          ...
          <div className="items-center gap-5 hidden md:flex">
            {isAuthenticated ? (
              <>
                <button
                  className={`primarybutton ${
                    isCheckingLimit ? "opacity-70 cursor-wait" : ""
                  }`}
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      toast.error(
                        "Could not verify product limits. Please try again."
                      );
                    } finally {
                ...
                <div className="relative" id="nav-message-icon-container">
                  ...
                  {(() => {
                    ...
                    const totalUnread = chats.reduce((acc, chat) => {
                      const count =
                        (chat.unreadCount && chat.unreadCount[currentUserId]) ||
                        0;
                      return acc + count;
                    }, 0);
              ...
              <>
                <button className="secondarybutton" onClick={openLogin}>
                  Sign-In
                </button>
                <button className="primarybutton" onClick={openRegister}>
                  Register
                </button>
              </>
            )}
