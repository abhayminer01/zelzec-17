  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] bg-gray-100 overflow-hidden">
        ...
        />
        <div className="absolute bottom-2 left-2 flex items-center gap-1 bg-black/60 backdrop-blur-md px-2 py-1 rounded-md border border-white/20">
          <MapPin className="size-3 text-white" />
          <span className="text-[10px] font-medium text-white truncate max-w-[100px]">
            {product.location?.place || "Location"}
          </span>
        </div>
      </div>
